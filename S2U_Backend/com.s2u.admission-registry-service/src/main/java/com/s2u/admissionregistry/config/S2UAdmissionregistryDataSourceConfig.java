...
@EnableJpaRepositories(basePackages = "com.s2u.admissionregistry.repository", entityManagerFactoryRef = "s2uEntityManager", transactionManagerRef = "s2uTransactionManager")
public class S2UAdmissionregistryDataSourceConfig {
	...
	public LocalContainerEntityManagerFactoryBean s2uEntityManager() {
		...
		em.setPackagesToScan("com.s2u.admissionregistry.entity");
